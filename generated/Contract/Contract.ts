...
export class Contract extends ethereum.SmartContract {
  ...
  getTokenData(tokenId: BigInt): string {
    let result = super.call("getTokenData", "getTokenData(uint256):(string)", [
      ethereum.Value.fromUnsignedBigInt(tokenId)
    ]);
  ...
  try_getTokenData(tokenId: BigInt): ethereum.CallResult<string> {
    let result = super.tryCall(
      "getTokenData",
      "getTokenData(uint256):(string)",
      [ethereum.Value.fromUnsignedBigInt(tokenId)]
    );
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  getTokenIdsByURI(tokenURI: string): Array<BigInt> {
    let result = super.call(
      "getTokenIdsByURI",
      "getTokenIdsByURI(string):(uint256[])",
  ...
  try_getTokenIdsByURI(tokenURI: string): ethereum.CallResult<Array<BigInt>> {
    let result = super.tryCall(
      "getTokenIdsByURI",
      "getTokenIdsByURI(string):(uint256[])",
      [ethereum.Value.fromString(tokenURI)]
